...
export const CLARITY_BUILTINS: ClarityBuiltin[] = [
  ...
  },
  {
    ...
    returnType: STRING,
    effects: [],
    doc: "Convert all characters in s to uppercase.",
    category: "string",
  },
  {
    name: "to_lowercase",
    ...
    returnType: STRING,
    effects: [],
    doc: "Convert all characters in s to lowercase.",
    category: "string",
  },
  {
    name: "trim_start",
  ...
  {
    name: "pad_left",
    params: [STRING, INT64, STRING],
    paramNames: ["s", "width", "char"],
    returnType: STRING,
    effects: [],
    doc: "Pad s on the left with char until the total length is width. If s is already at least width characters, return s unchanged. char should be a single character.",
    category: "string",
  },
  {
    name: "pad_right",
    ...
    returnType: STRING,
    effects: [],
    doc: "Pad s on the right with char until the total length is width. If s is already at least width characters, return s unchanged. char should be a single character.",
    category: "string",
  },
  {
    name: "split_lines",
    ...
    effects: [],
    doc: "Split s into lines, recognising \\n, \\r\\n, and \\r as line endings. Returns a list of strings (without terminators).",
    category: "string",
  },
  {
    name: "chars",
    ...
    returnType: { kind: "List", element: STRING },
    effects: [],
    doc: "Return a list of single-character strings from s (Unicode code-point iteration).",
    category: "string",
  },
  ...
  },
  {
    ...
    returnType: FLOAT64,
    effects: [],
    doc: "Natural logarithm (base e) of x.",
    category: "math",
  },
  {
    name: "log2",
  ...
  },
  {
    ...
    returnType: FLOAT64,
    effects: [],
    doc: "e raised to the power x (e^x).",
    category: "math",
  },
  {
    name: "sin",
  ...
  },
  {
    ...
    returnType: FLOAT64,
    effects: [],
    doc: "Two-argument arctangent: angle (in radians) of the vector (x, y) from the positive x-axis. Range: (-π, π].",
    category: "math",
  },
  ...
  },
  {
    ...
    returnType: LIST_STRING,
    effects: ["FileSystem"],
    doc: "Return a list of entry names (files and subdirectories) in the given directory. Names are not sorted. Returns an empty list if the directory does not exist or cannot be read.",
    category: "io",
  },
  {
    name: "file_exists",
    ...
    returnType: BOOL,
    effects: ["FileSystem"],
    doc: "Return True if a file or directory exists at the given path, False otherwise.",
    category: "io",
  },
  {
    name: "remove_file",
    ...
    returnType: UNIT,
    effects: ["FileSystem"],
    doc: "Remove the file at the given path. Does nothing if the file does not exist. Raises a runtime error if the path is a directory.",
    category: "io",
  },
  {
    name: "make_dir",
  ...
  },
  {
    ...
    returnType: { kind: "Result", ok: STRING, err: STRING } as ClarityType,
    effects: ["Network"],
    doc: "Perform a generic HTTP request with custom method, URL, headers (as a JSON object string), and body. Returns Ok(response_body) on 2xx or Err(message) on failure. Pass \"{}\" for no custom headers or \"\" for no body.",
    category: "network",
  },
  ...
  },
  {
    ...
    effects: [],
    doc: "Extract a top-level value from a JSON object by key. Returns Some(value) for scalar values (string, number, bool) or Some(json_string) for nested objects/arrays. Returns None if the key is missing or the input is not a JSON object.",
    category: "json",
  },
  {
    name: "json_get_path",
