...
export function getKnownEffectNames() {
    return new Set(EFFECT_DEFINITIONS.map((e) => e.name));
}
/** Get all built-ins for a given effect */
export function getBuiltinsForEffect(effectName) {
...
//# sourceMappingURL=builtins-registry.js.map