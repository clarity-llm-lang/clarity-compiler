...
import { ERROR_TYPE, resolveBuiltinType, typesEqual, typeToString, containsTypeVar, } from "./types.js";
import { Environment } from "./environment.js";
import { validateEffectNames } from "./effects.js";
...
export class Checker {
    ...
    checkModule(module, importedSymbols = [], importedTypes = []) {
        ...
        const localFuncNames = new Set(module.declarations
            ...
            .map((d) => d.name));
        warnMutualTailRecursion(this.diagnostics, module.declarations.filter((d) => d.kind === "FunctionDecl"), localFuncNames);
