...
export type Expr = IntLiteral | FloatLiteral | StringLiteral | BoolLiteral | ListLiteral | RecordLiteral | IdentifierExpr | BinaryExpr | UnaryExpr | CallExpr | MemberExpr | MatchExpr | LetExpr | AssignmentExpr | BlockExpr | LambdaExpr;
