...
export function callAlloc(ctx, size) {
...
export function addTempLocal(ctx, wasmType) {
 ...
 */
export function buildClosureStruct(ctx, tableIdx, envPtrExpr) {
 ...
 */
export function getOrCreateWrapper(ctx, resolvedFuncName, fnType) {
 ...
 */
export function liftLambda(ctx, lambda) {
    ...
    for (const param of lambda.params) {
        const ct = ctx.checker.resolveTypeRef(param.typeAnnotation) ?? { kind: "Error" };
...
//# sourceMappingURL=codegen-closures.js.map