 ...
 */
export function resolveModules(entryFilePath) {
    const absEntry = path.resolve(entryFilePath);
    const resolved = new Map();
    const allErrors = [];
    function resolve(filePath, importSpan) {
        ...
        const mod = { filePath: abs, ast, errors: [] };
 ...
 */
export function resolveModulePath(importerPath, modulePath) {
 ...
 */
function topologicalSort(entryPath, resolved) {
